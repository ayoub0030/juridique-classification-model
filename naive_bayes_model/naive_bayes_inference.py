...
def predict_from_json_file(model, file_path, text_field='text'):
    ...
    # For EU legal documents, try to combine header and recitals if text field is not found
...
def main():
    parser = argparse.ArgumentParser(description="Make predictions with a trained Naive Bayes model")
